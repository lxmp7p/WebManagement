...
img = {
    'mainbuilding': '<div id="sloi-1" style="display: block; background: rgba(0, 0, 0, 0) url(../static/img/map.png) '
                    ...
                    'href="#poligon" id="apoly-1" onclick="perehodKSloy(\'sloi-2\')"><polygon id="poly-1" points=" '
    ...
    'hoz_korp': '<div id="sloi-2"  style="display: none; background: rgba(0, 0, 0, 0) url(../static/img/f.png) no-repeat '
                ...
                'stroke="#333333"></polygon></a></svg></div></svg></div>',
}